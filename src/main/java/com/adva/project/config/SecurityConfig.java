package com.adva.project.config;
...
class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/announcement/forEmployee").hasAnyAuthority("employee:write","admin:write")

                // Dostęp tylko dla niezarejestrowanych użytkowników
                .antMatchers("/registration").not().fullyAuthenticated()
                .antMatchers("/login").not().fullyAuthenticated()

                //Dodajemy 2 dodatkowe punkty końcowe
                // i włączamy nadpisanie wlasnego formularza autoryzacji
                .and()
                .formLogin()
                ...
                .and().
                exceptionHandling().accessDeniedPage("/admin/forbidden")

                // A także w konfiguracji uwzględniamy "zapamiętaj mnie"
                .and()
